...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected EIGBankCoin supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check EIGBankCoin supply at the beginning
        # ------------------------------------------
        # EIGBankCoin supply: block rewards minus burned fees for minting
        ...
        # Verify that EIGBankCoin supplies were properly updated after the spends and reorgs
        self.log.info("Check EIGBankCoin supply...")
