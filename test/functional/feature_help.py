...
"""Verify that starting EIGBankCoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start EIGBankCoin with -? for help text")
        ...
        self.log.info("Start EIGBankCoin with -version for version information")
