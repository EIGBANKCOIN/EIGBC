Contributing to EIGBankCoin blockchain
============================

The EIGBankCoin blockchain project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/EIGBANKCOIN/EIGBC/blob/master/doc/translation_process.md)
...
The following applies to code changes to the EIGBankCoin blockchain project, and is not to be
confused with overall EIGBankCoin Network Protocol consensus changes.

Whether a pull request is merged into EIGBankCoin blockchain rests with the project merge
...
Patches that change EIGBankCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the EIGBankCoin consensus, it must have been
...
The project leader is the release manager for each EIGBankCoin blockchain release.
