...
# Create zip file of binaries
	cp $PROJECT_ROOT/src/eigbankcoind.exe $PROJECT_ROOT/src/eigbankcoin-cli.exe $PROJECT_ROOT/src/eigbankcoin-tx.exe $PROJECT_ROOT/src/qt/eigbankcoin-qt.exe .
	zip eigbankcoin-Windows.zip eigbankcoind.exe eigbankcoin-cli.exe eigbankcoin-tx.exe eigbankcoin-qt.exe
	rm -f eigbankcoind.exe eigbankcoin-cli.exe eigbankcoin-tx.exe eigbankcoin-qt.exe
