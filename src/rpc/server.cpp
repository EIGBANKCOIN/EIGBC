...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop eigbankcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "eigbankcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* eigbankcoin features */
/***
        {"eigbankcoin", "listmasternodes", &listmasternodes, true },
        {"eigbankcoin", "getmasternodecount", &getmasternodecount, true },
        {"eigbankcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"eigbankcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"eigbankcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"eigbankcoin", "masternodecurrent", &masternodecurrent, true },
        {"eigbankcoin", "startmasternode", &startmasternode, true },
        {"eigbankcoin", "createmasternodekey", &createmasternodekey, true },
        {"eigbankcoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"eigbankcoin", "listmasternodeconf", &listmasternodeconf, true },
        {"eigbankcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"eigbankcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"eigbankcoin", "getmasternodescores", &getmasternodescores, true },
        {"eigbankcoin", "mnsync", &mnsync, true },
        {"eigbankcoin", "spork", &spork, true },
***/
...
{
    return "> eigbankcoin-cli " + methodname + " " + args + "\n";
}
