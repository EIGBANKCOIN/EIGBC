...
/** Utility functions used by the EIGBC Qt UI.
 */
namespace GUIUtil
{
...
// Render EIGBC addresses in monospace font
...
// Parse "EIGBC:" URI into recipient object, return true on successful parsing
