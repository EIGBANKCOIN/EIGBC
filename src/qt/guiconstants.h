...
/* EIGBC GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EIGBankCoin"
#define QAPP_ORG_DOMAIN "eigbankcoin.io"
#define QAPP_APP_NAME_DEFAULT "EIGBankCoin-Qt"
#define QAPP_APP_NAME_TESTNET "EIGBankCoin-Qt-testnet"
