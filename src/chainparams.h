...
#define __PORT_MAINNET__ 15115
#define __PORT_TESTNET__ 25115
#define __PORT_REGTEST__ 35115
 ...
 * EIGBankCoin system. There are three: the main network on which people trade goods
