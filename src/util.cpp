...
const char * const PIVX_CONF_FILENAME = "eigbankcoin.conf";
const char * const PIVX_PID_FILENAME = "eigbankcoin.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";
const char * const PIVX_ACTIVE_MASTERNODE_CONF_FILENAME = "activemasternode.conf";


// EIGBankCoin only features
// Masternode
...
#else
    const char* pszModule = "eigbankcoin";
#endif
    if (pex)
        return strprintf(
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\EIGBankCoin
// Windows >= Vista: C:\Users\Username\AppData\Roaming\EIGBankCoin
// Mac: ~/Library/Application Support/EIGBankCoin
// Unix: ~/.eigbankcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EIGBankCoin";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty eigbankcoin.conf if it does not exist
        FILE* configFile = fsbridge::fopen(GetConfigFile(), "a");
        if (configFile != NULL){
            std::string strHeader = "# EIGBankCoin config file\n"
                          "rpcuser=username\n"
                          ...
                          "\n"
                          "# ADDNODES:\n"
                          "addnode=seed01.eigbankcoin.io\n"
                          "addnode=seed02.eigbankcoin.io\n"
                          "addnode=seed03.eigbankcoin.io\n"
                          "addnode=seed04.eigbankcoin.io\n"
                          "addnode=seed05.eigbankcoin.io\n"
                          "addnode=seed06.eigbankcoin.io\n"
                          "\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override eigbankcoin.conf
