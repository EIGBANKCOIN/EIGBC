...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EIGBankCoin eigbankcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  eigbankcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded EIGBankCoin transaction") + "\n" +
                               "  eigbankcoin-tx [options] -create [commands]   " + _("Create hex-encoded EIGBankCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded EIGBankCoin transaction
