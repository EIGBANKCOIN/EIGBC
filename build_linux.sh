...
# Create zip file of binaries
	cp eigbankcoin/src/eigbankcoind eigbankcoin/src/eigbankcoin-cli eigbankcoin/src/eigbankcoin-tx eigbankcoin/src/qt/eigbankcoin-qt .
	zip eigbankcoin-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip eigbankcoind eigbankcoin-cli eigbankcoin-tx eigbankcoin-qt
	rm -f eigbankcoind eigbankcoin-cli eigbankcoin-tx eigbankcoin-qt
